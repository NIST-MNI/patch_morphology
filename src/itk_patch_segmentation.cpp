...
#include "itkRegressionNonLocalFilter.h"
#include "itkSegmentationPreselectionFilter.h"

#include "itkSVMRegressionLabelling.h"
#include "itkNNLSRegressionLabelling.h"
#include "itkEXPSimilarityLabelling.h"
...
typedef itk::SVMRegressionLabelling<FeatureImageType,StructuringElementType>  SVMRegressorType;
typedef itk::NNLSRegressionLabelling<FeatureImageType,StructuringElementType> NNLSRegressorType;
typedef itk::ExpSimilarityLabelling<FeatureImageType,StructuringElementType>  EXPRegressorType;

typedef itk::RegressionNonLocalFilter<
                            FeatureImageType,
                            LabelImageType,
                            LabelImageType,
...
typedef SVMSegmentationFilterType::Superclass SegmentationBaseFilterType;
...
run_segmentation(int search_radius,
                int patch_radius,
                int discrete,
                ...
                )
{
  ...
  if(preselect_threshold>0.0)
  {
    ...
    do
    {
      ...
      StructuringElementType::RadiusType search_radius_;search_radius_.assign(search_radius);
...
//         break;
  ...
  try
  {
    ...
    if(preselect_threshold>0.0)
    {
      ...
      if(use_nnls)
        flt=run_segmentation<NNLSSegmentationFilterType,MeanAndSdPreselectionType,NNLSRegressorType>(
        ...
        flt=run_segmentation<EXPSegmentationFilterType,MeanAndSdPreselectionType,EXPRegressorType>(
                          search_radius, patch_radius, discrete, preselect_threshold, ball_structuring_element,
                          max_iterations,
                          verbose, in_img, roi_in,
                          trg_images, train_images,
        ...
        flt=run_segmentation<SVMSegmentationFilterType, MeanAndSdPreselectionType, SVMRegressorType>(
                          search_radius, patch_radius, discrete, preselect_threshold, ball_structuring_element,
                          max_iterations,
                          verbose,  in_img, roi_in,
                          trg_images, train_images,
      ...
      if(use_nnls)
        flt=run_segmentation<NNLSegmentationFilterNoPsType, itk::NOOPSegmentationPreselection<3>, NNLSRegressorType>(
                          search_radius, patch_radius, discrete, preselect_threshold, ball_structuring_element,
                          max_iterations,
                          verbose, in_img, roi_in,
                          trg_images, train_images,
        ...
        flt=run_segmentation<EXPSegmentationFilterNoPsType,itk::NOOPSegmentationPreselection<3>,EXPRegressorType>(
                          search_radius, patch_radius, discrete, preselect_threshold, ball_structuring_element,
                          max_iterations,
                          verbose, in_img, roi_in,
                          trg_images, train_images,
        ...
        flt=run_segmentation<SVMSegmentationFilterNoPsType, itk::NOOPSegmentationPreselection<3>, SVMRegressorType>(
                          search_radius, patch_radius, discrete, preselect_threshold, ball_structuring_element,
                          max_iterations,
                          verbose,  in_img, roi_in,
                          trg_images, train_images,
