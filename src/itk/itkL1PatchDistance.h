#ifndef _mincL1PatchDistance_h_
#define _mincL1PatchDistance_h_
...
namespace itk
{
  ...
  template<class TImage,class TPatch> class L1PatchDistance : public itk::LightObject
  {
  public:
    typedef L1PatchDistance Self;
  ...
  public:
                    ...
                    const PatchKernelIteratorType patchKernelEnd) const
    {
      ...
      for( i=0, kernel_it=patchKernelBegin; kernel_it<patchKernelEnd; ++kernel_it, ++i )
      {
        ...
        {
          double v=fabs((double)(patchIt1.GetPixel(i)-patchIt2.GetPixel(i)));
          total+=v;
          cnt++;
        }
      }
