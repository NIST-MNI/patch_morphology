#ifndef __itkGradingNonLocalFilter_txx
#define __itkGradingNonLocalFilter_txx
...
template<class TFeatureImage,class TLabelImage, class TOutputImage, class TSearch, class TPatch,class TRegressor,class TPreselectionFilter,class TRealType>
GradingNonLocalFilter<TFeatureImage,TLabelImage,TOutputImage,TSearch,TPatch,TRegressor,TPreselectionFilter,TRealType>
