#ifndef __itkGradingNonLocalFilter_h
#define __itkGradingNonLocalFilter_h
...
class  GradingNonLocalFilter : 
    public itk::ImageToImageFilter<TFeatureImage, TOutputImage>
  {
  public:
    
    /** Standard class typedefs. */
    typedef GradingNonLocalFilter Self;
    ...
    itkTypeMacro(GradingNonLocalFilter,itk::ImageToImageFilter);
  ...
  /** Neighborhood iterator type. */
    ...
    /** GradingNonLocalFilter need to make sure they request enough of an
  ...
  private:
    GradingNonLocalFilter(const Self&); //purposely not implemented
...
#include "itkGradingNonLocalFilter.txx"

#endif //__itkGradingNonLocalFilter_h
