#ifndef _mincVectorL1PatchDistance_h_
#define _mincVectorL1PatchDistance_h_
...
namespace itk
{
  ...
  template<class T1,class T2> T1 WeightedL1Distance(
  ...
  template<class TImage,class TPatch> 
    class VectorL1PatchDistance : public itk::LightObject
  {
  public:
    typedef VectorL1PatchDistance Self;
    itkTypeMacro(VectorL1PatchDistance, itk::LightObject);    
  ...
  public:
                    ...
                    const PatchKernelIteratorType patchKernelEnd) const
    {
      ...
      for( i=0, kernel_it=patchKernelBegin; kernel_it<patchKernelEnd; ++kernel_it, ++i )
      {
        ...
        {
          total+=
            WeightedL1Distance<double,PixelType>(
              patchIt1.GetPixel( i ),
              patchIt2.GetPixel( i ),
              m_Weights );
...
#endif //_mincVectorL1PatchDistance_h_