#ifndef _ITK_NNLS_REGRESSION_LABELLING_h_
#define _ITK_NNLS_REGRESSION_LABELLING_h_
...
namespace itk
{
  template<class TImage,class TPatch> class NNLSRegressionLabelling: public itk::LightObject
  {
  public:
  ...
  /** Neighborhood iterator type. */
    ...
    NNLSRegressionLabelling(const Self&); //purposely not implemented
...
#endif //_ITK_NNLS_REGRESSION_LABELLING_h_