#ifndef _ITK_SVM_REGRESSION_LABELLING_h_
#define _ITK_SVM_REGRESSION_LABELLING_h_
...
namespace itk
{
  template<class TImage,class TPatch> class SVMRegressionLabelling: public itk::LightObject
  {
  public:
  ...
  /** Neighborhood iterator type. */
    ...
    SVMRegressionLabelling(const Self&); //purposely not implemented
...
#endif //_ITK_SVM_REGRESSION_LABELLING_h_