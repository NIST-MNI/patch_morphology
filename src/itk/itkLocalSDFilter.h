...
---------------------------------------------------------------------------- */
#ifndef __mincLocalSDFilter_h__
#define __mincLocalSDFilter_h__
...
namespace itk
{
	...
	template <class TInputImage, class TOutputImage, class TKernel> class LocalSDFilter:
		public itk::MorphologyImageFilter<TInputImage, TOutputImage, TKernel>
	{
public:
  /** Standard class typedefs. */
  typedef LocalSDFilter Self;
...
private:
  LocalSDFilter(const Self&); //purposely not implemented
  void operator=(const Self&); //purposely not implemented

	};

} //minc
#include "itkLocalSDFilter.txx"

#endif // __mincLocalSDFilter_h__
